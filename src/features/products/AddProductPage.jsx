    ...
    <div>
      <div className='bg-primary-200 flex flex-col items-center justify-center mx-4 p-4 md:mx-8 rounded-lg shadow-lg'>
        <form
          ...
          />
          {errors.price && <p className='text-accent-700 text-sm'>El precio es requerido y debe ser un número mayor a 0</p>}
          <label
            className='text-secondary-600 text-shadow-lg text-lg font-bold text-center'
            htmlFor='brand'>
            Stock
          ...
          />
          {errors.stock && <p className='text-accent-700 text-sm'>El stock es requerido y debe ser un número mayor o igual a 0</p>}
          <button
